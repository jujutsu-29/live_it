    ...
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'bg-popover text-popover-foreground z-50 min-w-[8rem] rounded-md border p-1 shadow-md ' +
          ...
          'origin-[var(--radix-dropdown-menu-content-transform-origin)] overflow-auto',
        className
      )}
      {...props}
    />
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      'relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none ' +
        'focus:bg-accent focus:text-accent-foreground ' +
        'data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/20 ' +
